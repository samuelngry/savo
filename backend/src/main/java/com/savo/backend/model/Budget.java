...
public class Budget {
    ...
    // One budget can have many progress records (monthly/weekly tracking)
    ...
    public List<BudgetProgress> getBudgetProgress() {
        return budgetProgress;
    }

    public void setBudgetProgress(List<BudgetProgress> budgetProgress) {
